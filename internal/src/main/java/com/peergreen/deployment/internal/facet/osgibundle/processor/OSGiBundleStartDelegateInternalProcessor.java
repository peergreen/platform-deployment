...
@Component
@Provides
@Instantiate(name="OSGi bundle start processor")
public class OSGiBundleStartDelegateInternalProcessor extends DelegateHandlerProcessor<Bundle> {

    public OSGiBundleStartDelegateInternalProcessor() throws ProcessorException {
        super(new OSGiBundleStartProcessor(), Bundle.class);
    }
    ...
    protected void addRequirements() {
        ...
        // Execute at the OSGi start phase
        addRequirement(getRequirementBuilder().buildPhaseRequirement(this, "START"));
