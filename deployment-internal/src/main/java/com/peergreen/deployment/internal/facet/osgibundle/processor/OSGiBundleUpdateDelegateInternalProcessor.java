...
@Component
@Provides
@Instantiate(name="OSGi bundle update processor")
public class OSGiBundleUpdateDelegateInternalProcessor extends DelegateHandlerProcessor<Bundle> {

    public OSGiBundleUpdateDelegateInternalProcessor() throws ProcessorException {
        super(new OSGiBundleUpdateProcessor(), Bundle.class);
    }
    ...
    protected void addRequirements() {
        ...
        // Execute only on a facet
        addRequirement(getRequirementBuilder().buildFacetRequirement(this, Bundle.class));

        // Execute at the OSGi UPDATE phase
        addRequirement(getRequirementBuilder().buildPhaseRequirement(this, "UPDATE"));
