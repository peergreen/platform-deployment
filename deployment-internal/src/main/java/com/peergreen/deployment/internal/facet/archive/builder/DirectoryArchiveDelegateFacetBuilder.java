...
/**
 * Defines delegate builder for Directory Archive
 * @author Florent Benoit
 */
@Component
@Provides
@Instantiate
public class DirectoryArchiveDelegateFacetBuilder extends DelegateFacetBuilder<Archive> implements FacetBuilder<Archive> {

    public DirectoryArchiveDelegateFacetBuilder() {
        super(new DirectoryArchiveFacetBuilder(), Archive.class);
    }
