 ...
 */
public class FacetRequirementImpl extends AbsDeploymentRequirement implements FacetRequirement {

    public FacetRequirementImpl(Resource resource, Class<?> facetClass) {
