...
/**
 * Defines delegate builder for JAR Archive
 * @author Florent Benoit
 */
@Component
@Provides
@Instantiate
public class JArArchiveDelegateFacetBuilder extends DelegateFacetBuilder<Archive> implements FacetBuilder<Archive> {

    public JArArchiveDelegateFacetBuilder() {
        super(new JarArchiveFacetBuilder(), Archive.class);
    }
