...
@Component
@Provides
@Instantiate(name="OSGi bundle stop processor")
public class OSGiBundleStopDelegateInternalProcessor extends DelegateHandlerProcessor<Bundle> {

    public OSGiBundleStopDelegateInternalProcessor() throws ProcessorException {
        super(new OSGiBundleStopProcessor(), Bundle.class);
    }
    ...
    protected void addRequirements() {
        ...
        addRequirement(getRequirementBuilder().buildPhaseRequirement(this, "STOP"));
