...
@Provides
@Instantiate
public class UndeployPostConfigProcessorDelegateHandlerProcessor extends DelegateHandlerProcessor<DeploymentContext> {

    public UndeployPostConfigProcessorDelegateHandlerProcessor() {
        super(new UndeployPostConfigProcessor(), DeploymentContext.class);
    }
    ...
    protected void addRequirements() {
        // Execute at the UNDEPLOY_POSTCONFIG lifecycle
       addRequirement(getRequirementBuilder().buildPhaseRequirement(this, InternalPhases.UNDEPLOY_POSTCONFIG.toString()));
