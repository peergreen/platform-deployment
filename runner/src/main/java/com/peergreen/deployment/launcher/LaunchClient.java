...
public class LaunchClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String shelbieVersion = "2.0.0-M2";
        Option[] options = options(
                ...
                mavenBundle().groupId("org.apache.felix").artifactId("org.apache.felix.ipojo.handler.whiteboard").version("1.6.0"),
                ...
                mavenBundle().groupId("org.ow2.shelbie").artifactId("shelbie-core").version(shelbieVersion),
                mavenBundle().groupId("org.ow2.shelbie").artifactId("shelbie-startup-console").version(shelbieVersion),
                mavenBundle().groupId("org.ow2.shelbie").artifactId("shelbie-commands-builtin").version(shelbieVersion),
                /*mavenBundle().groupId("org.ow2.shelbie").artifactId("shelbie-config-commands").version(shelbieVersion),*/
                /*mavenBundle().groupId("org.ow2.shelbie").artifactId("shelbie-ipojo-commands").version(shelbieVersion),*/
